...
public class NotificationPreferenceVO implements Serializable {
    ...
    private int fireIntervalMinutes;
    ...
    public NotificationPreferenceVO(Long key, Long userId, Platform platform, boolean fireDetection, int fireIntervalMinutes, boolean inviteStatus, boolean inviteReceived, boolean teamGoalReached, ZonedDateTime createdAt, ZonedDateTime updatedAt) {
        this.key = key;
        this.userId = userId;
    ...
    public void setFireIntervalMinutes(int fireIntervalMinutes) {
        this.fireIntervalMinutes = fireIntervalMinutes;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getKey(), getUserId(), getPlatform(), isFireDetection(), getFireIntervalMinutes(), isInviteStatus(), isInviteReceived(), isTeamGoalReached(), getCreatedAt(), getUpdatedAt());
    }
}
