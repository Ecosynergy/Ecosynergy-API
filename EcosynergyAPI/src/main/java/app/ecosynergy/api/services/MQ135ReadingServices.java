...
public class MQ135ReadingServices {
    ...
    public MQ135ReadingVO findById(Long id){
        ...
        MQ135ReadingVO vo = ModelMapper.parseObject(reading, MQ135ReadingVO.class);
    ...
    public List<MQ135ReadingVO> findAll(){
        ...
        List<MQ135ReadingVO> voList = ModelMapper.parseListObject(readingsList, MQ135ReadingVO.class);
        voList.forEach(vo -> {
            vo.add(linkTo(methodOn(MQ135ReadingController.class).findById(vo.getKey())).withSelfRel());
        });
    ...
    public MQ135ReadingVO create(MQ135ReadingVO reading){
        ...
        MQ135Reading readingEntity = repository.save(ModelMapper.parseObject(reading, MQ135Reading.class));

        MQ135ReadingVO vo = ModelMapper.parseObject(readingEntity, MQ135ReadingVO.class);
        vo.add(linkTo(methodOn(MQ135ReadingController.class).findById(vo.getKey())).withSelfRel());
